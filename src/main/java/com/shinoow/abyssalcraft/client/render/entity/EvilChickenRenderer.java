 ...
 */
public class EvilChickenRenderer extends MobRenderer<EvilChicken, ChickenModel<EvilChicken>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(EvilChicken entity) {
        return TEXTURE;
    }
}
