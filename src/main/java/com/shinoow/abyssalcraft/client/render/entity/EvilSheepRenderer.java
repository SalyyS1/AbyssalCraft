 ...
 */
public class EvilSheepRenderer extends MobRenderer<EvilSheep, CowModel<EvilSheep>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(EvilSheep entity) {
        return TEXTURE;
    }
}
