 ...
 */
public class DepthsGhoulRenderer extends MobRenderer<DepthsGhoul, HumanoidModel<DepthsGhoul>> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(AbyssalCraft.MOD_ID, "textures/model/depths_ghoul.png");

    public DepthsGhoulRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public ResourceLocation getTextureLocation(DepthsGhoul entity) {
        return TEXTURE;
    }
}
