 ...
 */
public class AntiCow extends Animal implements IAntiEntity {

    private static final Ingredient BREEDING_ITEMS = Ingredient.of(net.minecraft.world.item.Items.WHEAT);

    public AntiCow(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(3, new TemptGoal(this, 1.25D, BREEDING_ITEMS, false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
        return ACEntities.ANTI_COW.get().create(level);
    }
}
