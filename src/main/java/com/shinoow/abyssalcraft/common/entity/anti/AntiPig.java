 ...
 */
public class AntiPig extends Animal implements IAntiEntity {

    private static final Ingredient BREEDING_ITEMS = Ingredient.of(net.minecraft.world.item.Items.CARROT);

    public AntiPig(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(3, new TemptGoal(this, 1.2D, BREEDING_ITEMS, false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
        return ACEntities.ANTI_PIG.get().create(level);
    }
}
